...
const Hero = ({ handleOrderPopup }) => {
  return (
    <section className="relative w-full overflow-hidden mb-10">
      ...
      {/* Hero Wrapper */}
      <div className="relative w-full h-[70vh] sm:h-[60vh] md:h-[80vh] lg:h-[100vh] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col items-center justify-center text-center text-white h-full">
          ...
          <h1
            ...
            data-aos-once="true"
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 leading-tight drop-shadow-lg uppercase"
          >
            Deepsea Challenge
          </h1>
